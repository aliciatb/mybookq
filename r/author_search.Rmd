...
```{r upcoming_book_descriptions, fig.width=18, fig.height=8}
...
I also would like to have a good idea on the likelihood of enjoying a book because even my most favorite author will occasionally drift into murky and less cheerful mysteries or even worse, produce a stand-alone novel that includes none of my favorite fictional friends. By performing rudimentary sentiment analysis as well as checking for specific key words, I will score an Anticipation Index for all not yet released books.

Thanks to Julia Silge and David Robinson's awesome book  [Text Mining with R: A Tidy Approach](https://www.tidytextmining.com)! Get it on [https://smile.amazon.com/dp/B071K9RT9Z](Amazon)!
